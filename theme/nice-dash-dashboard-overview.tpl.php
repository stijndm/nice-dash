  ...
  <table id="fields" class="sticky-enabled">
    ...
    <?php foreach ($rows as $row): ?>
      ...
      <tr class="<?php print $count % 2 == 0 ? 'odd' : 'even'; ?> draggable property-row">
        ...
        <td><?php print l(t('View'), 'admin/dashboard/'. $row->machine_name) .' | '. l(t('Edit'), 'admin/build/dashboard/dashboards/'. $row->did .'/edit') .' | '. l(t('Delete'), 'admin/build/dashboard/dashboards/'. $row->did .'/delete'); ?></td>
